...
func TestGenerateRandomString(t *testing.T) {
	...
	for i := 1; i <= 10; i++ {
		randomString = append(randomString, RandomString(16))
...
func TestGenerateRandomInt(t *testing.T) {
	var randomInt []int64
	for i := 1; i <= 10; i++ {
		randomInt = append(randomInt, RandomInt(1, 10))
...
func TestGenerateRandomCombine(t *testing.T) {
	...
	for i := 1; i <= 10; i++ {
		...
		randomCombine = append(randomCombine, RandomString(10)+stringNumber)
	...
	for i := 1; i <= 10; i++ {
		randomCombine := RandomCombineIntAndString()
		fmt.Println(randomCombine)
	}
}
